...
class HomeScreen:
    ...
    def __init__(self, driver):
        self.driver = driver
        self.title = WebDriverWait(self.driver.instance, 20).until(EC.visibility_of_element_located((By.CLASS_NAME, 'site-title')))
        ...
        self.posts = WebDriverWait( self.driver.instance, 10).until(EC.presence_of_all_elements((By.TAG_NAME, 'article')))
